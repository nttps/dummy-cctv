<template>
  <div class="threeview">
    <div class="flex justify-center">
      <div class="flex flex-row border-2 border-black p-5 w-5/12 mt-10 bg-orange-500">
        <!-- First section -->
        <div class="border-2 border-black p-5 w-1/2 bg-black-500" :class="{ 'bg-black border-black': isAddClicked }" ></div>  
        ...
        <!-- Second section -->
        <div class="border-2 border-white p-5 w-1/2 bg-black text-white" :class="{ 'bg-black border-black': isAddClicked2 }" > 
...
function saveDataAndNavigate() {
  router.push({ name: 'WarRoom', query: { content: 'threeview', isAddClicked: isAddClicked.value.toString() , isAddClicked2: isAddClicked2.value.toString() } });
}
